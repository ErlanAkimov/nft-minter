import { Address, beginCell, Cell, internal, SendMode, toNano } from '@ton/ton';
import { OpenedWallet } from '../typescript/types';
import { NftCollection } from './NftCollection';
import { TonClient } from '@ton/ton';
import { mintParams } from '../typescript/types';
import { toncenter } from '../configs/network';
...
export class NftItem {
	...
	public async deploy(wallet: OpenedWallet, params: mintParams, seqno: number) {
	...
	static createTransferBody(params: { newOwner: Address; responseTo?: Address; forwardAmount?: bigint }): Cell {
	...
	static async transfer(wallet: OpenedWallet, nftAddress: Address, newOwner: Address): Promise<number> {
